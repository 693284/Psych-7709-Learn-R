...
A sim.anova is a simulation function that falls under an all incompasing package called "psych." The sim.anova function enables one to 
...
```{r}
data.df <- sim.anova(es1=8, es2 = 10, es12 = 5, n1=2, n2=2)  # one main effect and one interaction
describe(data.df)
pairs.panels(data.df)
```
